...
abstract class UnityExtension {
    ...
    @Internal abstract DirectoryProperty getSharedCachePath()
    ...
    void initializePropertyValues() {
        ...
        sharedCachePath.convention(project.layout.projectDirectory.dir("${System.getProperty('user.home')}/.iptech-unity-plugin/sharedCache"))
